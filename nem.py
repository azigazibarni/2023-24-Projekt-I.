...
def operations():
    ...
    esc = Button(frame3, width=5, text='Vissza', relief='groove', command=homePage)
    esc.grid(row=0, column=0, columnspan=8, sticky=W, padx=(15, 0))
    ...
    operations = ttk.Combobox(frame3, width = 5, values=['+', '-', '*', '%'])
    operations.grid(row = 2, column = 2, pady = (0, 60))
    ...
    calc = Button(frame3, width = 5, text = '=', relief = 'groove', command = calculate)
    calc.grid(row = 2, column = 5, pady = (0, 60))
